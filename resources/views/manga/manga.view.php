<div class="querypage_left-column">
    ...
    <section class="querypage_info two-column-list box">
        ...
        <ul>
            <li><span class="ul_first-column">type</span><span><?=$mangaInfo['type']?></span></li>
            <li><span class="ul_first-column">episodes</span><span><?=$mangaInfo['episodes']?></span></li>
            ...
            <li><span class="ul_first-column">season</span><span><?=$mangaInfo['season']?></span></li>
            <li><span class="ul_first-column">studios</span><span><?=$mangaInfo['studios']?></span></li>
        </ul>
    </section>
