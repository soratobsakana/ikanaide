<section class="profile_user-overview">
        ...
        <section class="profile_user-overview_bio box-wrapper">
            ...
            ?>
            <div class="box-body biography">
                <p><?=htmlspecialchars($userInfo['biography'])?></p>
            </div>
            <?php }

            if (isset($userInfo['twitter']) || isset($userInfo['github']) || isset($userInfo['discord']) || isset($userInfo['websiter'])) {
                ?>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <a target="_blank" href="https://twitter.com/<?=$userInfo['twitter']?>">@<?=htmlspecialchars($userInfo['twitter'])?></a>
                    </li>
                    <?php } ?>
                    <?php if (isset($userInfo['github'])) { ?>
                    <li>
                        <span>
                        ...
                        <a target="_blank" href="https://github.com/<?=$userInfo['github']?>"><?=htmlspecialchars($userInfo['github'])?></a>
                    </li>
                    <?php } ?>
                    <?php if (isset($userInfo['discord'])) { ?>
                    <li>
                        <span>
                        ...
                        <?=htmlspecialchars($userInfo['discord'])?>
                    </li>
                    <?php } ?>
                    ...
                    <li>
                        ...
                        <?php
                        if (substr($userInfo['website'], 0, 5) === 'https') {
                            echo htmlspecialchars(substr($userInfo['website'], 8));
                        } else {
                            echo htmlspecialchars(substr($userInfo['website'], 7));
                        }
                        ?> 
                        </a>
                    </li>
